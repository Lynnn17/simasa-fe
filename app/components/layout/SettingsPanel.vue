      ...
      <div class="p-6 space-y-8">
        ...
        <div>
          ...
          <div class="grid grid-cols-2 gap-3">
            ...
            >
              <div
                class="w-6 h-6 border-2 rounded flex overflow-hidden"
                :class="
                  configStore.sidebarLayout === 'vertical'
            ...
            >
              <div
                class="w-6 h-6 border-2 rounded flex flex-col overflow-hidden"
                :class="
                  configStore.sidebarLayout === 'horizontal'
                    ? 'border-primary-500'
                    : 'border-slate-400'
        ...
        <div>
          ...
          <div class="grid grid-cols-2 gap-3">
            ...
            >
              <div
                class="w-6 h-6 border-2 rounded flex items-center justify-center overflow-hidden"
                :class="
                  configStore.contentLayout === 'box'
                    ? 'border-primary-500'
                    : 'border-slate-400'
